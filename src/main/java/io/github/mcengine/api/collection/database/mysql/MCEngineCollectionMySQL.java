package io.github.mcengine.api.collection.database.mysql;
...
/**
 * MySQL implementation of the MCEngineCollection database connection.
 */
public class MCEngineCollectionMySQL implements IMCEngineCollectionDB {
    ...
    /**
     * Persistent MySQL connection (may be {@code null} if connection fails).
     */
     ...
     */
    public MCEngineCollectionMySQL(Plugin plugin) {
        this.plugin = plugin;
     ...
     *
     * @return Active {@link Connection} to the MySQL database, or {@code null} if unavailable.
     */
    @Override
